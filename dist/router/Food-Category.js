...
exports.foodCategoryRouter.put("/:id", Food_1.auth, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
exports.foodCategoryRouter.delete("/:id", Food_1.auth, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
exports.foodCategoryRouter.post("/", Food_1.auth, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { name } = req.body;
