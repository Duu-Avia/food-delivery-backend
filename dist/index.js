...
const Food_categories_1 = require("./router/Food-categories");
...
app.use(cors({ origin: ['https://food-delivery-henna-zeta.vercel.app', "http://localhost:3000"] }));
...
connectMongoDB();
//food category path----------------
app.use("/food_category", Food_categories_1.foodCategoryRouter);
//dishes path----------------
